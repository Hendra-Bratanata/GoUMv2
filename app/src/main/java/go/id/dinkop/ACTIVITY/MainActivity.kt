...
import go.id.dinkop.ACTIVITY.DetailActivity.DetailBannerActivity
import go.id.dinkop.ACTIVITY.DetailActivity.DetailProductActivity
import go.id.dinkop.ADAPTER.BannerAdapter
import go.id.dinkop.ADAPTER.KatagoryAdapter
import go.id.dinkop.ADAPTER.PromoAdapter
import go.id.dinkop.ApiRepository.ApiReposirtory
import go.id.dinkop.INTERFACE.MainView
import go.id.dinkop.ITEM.JobService
import go.id.dinkop.ITEM.SharedPreference
import go.id.dinkop.POJO.Banner
import go.id.dinkop.POJO.Produk
import go.id.dinkop.PRESENTER.PromoPresenter
